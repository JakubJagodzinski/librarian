...
namespace librarian.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BlacklistedReaders",
                columns: table => new
                {
                    BlacklistedReaderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReaderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlacklistedReaders", x => x.BlacklistedReaderId);
                    table.ForeignKey(
                        name: "FK_BlacklistedReaders_Readers_ReaderId",
                        column: x => x.ReaderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlacklistedReaders_ReaderId",
                table: "BlacklistedReaders",
                column: "ReaderId",
                unique: true);
